...
const GATE_LOG: Array<[string | null, string | null, string | null, AttendanceStatus]> = [
...
const MANAGERS = ['Shahid Mehmood', 'Nadia Iqbal', 'Adeel Shah', 'Zayaan Veqar'];
...
export const employees: EmployeeRecord[] = ROSTER.map(
  ([name, employeeId, designation, department], i) => ({
    ...
    employmentStatus: (i % 11 === 4 ? 'Probation' : 'Active') as EmploymentStatus,
...
export const attendance: AttendanceRecord[] = employees.map((employee, i) => {
  ...
  return {
    ...
    confidence: checkIn ? Number((0.9 + ((i * 13) % 9) / 100).toFixed(2)) : null,
  };
});

/** Weekly present/late/absent/leave pattern per employee for the dashboard matrix. */
export const WEEK_PATTERNS = ['pppplpa', 'plppplA', 'ppapplp', 'ppppppl', 'palppla', 'pppplpp'];
...
export const clockInStream = [
  { name: 'Affan Zahoor', camera: 'nvr4 d12 Gate 2', time: '07:46:22 am', late: false },
  { name: 'Dawood Hassan', camera: 'nvr4 d12 Gate 2', time: '08:19:03 am', late: true },
  { name: 'Shayan Peerzada', camera: 'nvr2 d03 Gate 1', time: '06:51:37 am', late: false },
  { name: 'Zayaan Veqar', camera: 'nvr4 d12 Gate 2', time: '07:58:10 am', late: false },
  { name: 'Ammar Ahmed', camera: 'nvr2 d03 Gate 1', time: '08:37:29 am', late: true },
  { name: 'Sennan Desouza', camera: 'nvr7 d21 Admin Block', time: '07:59:44 am', late: false },
];

/** Employees flagged by the attendance risk index. */
export const riskList = [
  { name: 'Haseeb Naeem', employeeId: 'LTM-00621', meta: '6 absences · 4 late · Security', score: 82 },
  { name: 'Ammar Ahmed', employeeId: 'LTM-01055', meta: '5 absences · 6 late · Spinning — LTM-6', score: 74 },
  { name: 'Dawood Hassan', employeeId: 'LTM-01310', meta: '3 absences · 9 late · Quality Control', score: 68 },
  { name: 'Shayan Peerzada', employeeId: 'LTM-00982', meta: '4 absences · 3 late · Maintenance', score: 55 },
  { name: 'Nadia Iqbal', employeeId: 'LTM-00790', meta: '2 absences · 7 late · Administration', score: 47 },
];
...
/** Punctuality split for the current week. */
export const weeklyPunctuality = [
  ...
  { day: 'SAT', onTime: 44, late: 16, absent: 20 },
];
...
export const savedReports = [
  { id: 'rp-1', name: 'August 2026 — monthly register', format: 'xlsx', size: '2.4 MB' },
  { id: 'rp-2', name: 'Late arrivals — week 36', format: 'pdf', size: '640 KB' },
  { id: 'rp-3', name: 'Overtime ledger — Q3', format: 'xlsx', size: '1.1 MB' },
];

export const recentPunches = [
  { kind: 'Check in — matched', camera: 'nvr4 d12 Gate 2 · 0.97', time: '07:52:14 am' },
  ...
  { kind: 'Check out — matched', camera: 'nvr4 d12 Gate 2 · 0.98', time: '05:04:02 pm' },
  { kind: 'Check in — matched', camera: 'nvr4 d12 Gate 2 · 0.94', time: 'Yesterday 07:49 am' },
];

/** Headline figures — the design shows a 1,300-strong workforce. */
